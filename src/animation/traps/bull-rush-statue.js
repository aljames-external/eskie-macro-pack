...
async function create(tile, targets, config = {}) {
    ...
    if (targetLoc) {
        ...
        seq = seq
            ...
            .animateProperty('sprite', 'position.x', { to: 0, duration: 3000, ease: 'easeInOutQuad', delay: 700 })
            .animateProperty('sprite', 'position.y', { to: 0, duration: 3000, ease: 'easeInOutQuad', delay: 700 })
            .belowTokens()
            .duration(4000)
            .zIndex(0)
