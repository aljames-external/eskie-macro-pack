...
function movement1create(red, blue, config = {}) {
    ...
    seq.animation()
        ...
        .animation()
            .on(blue)
            .teleportTo(b3, {relativeToCenter: true})

        
        .animation()
            .on(red)
            .teleportTo(r3, {relativeToCenter: true})

        
        .wait(750)

        .canvasPan()
            .atLocation(midpoint(r3, b3))
            .scale(config.zoom)
        ...
        .effect()
            ...
            .atLocation(b3, {offset:{x:-0.35}, gridUnits:true})
            .size(2, {gridUnits:true})
            .zIndex(1)
            .mirrorX()
            .opacity(0.1)
        ...
        .effect()
            .delay(100)
            .file(closest("eskie.smoke.01.white"))
            .atLocation(r3, {offset:{x:0.35}, gridUnits:true})
            .size(2, {gridUnits:true})
            .zIndex(1)
            .opacity(0.1)
            .belowTokens()
...
function movement2create(red, blue, config = {}) {
    ...
    .effect()
        ...
        .animateProperty("spriteContainer", "position.x", { from: 0.75, to: 0, duration: 250, delay: 2250, gridUnits: true, ease: "easeOutSine"})
        //2nd attack
        .animateProperty("spriteContainer", "position.x", { from: 0, to: -0.2, duration: 250, delay: 2500, gridUnits: true, ease: "easeOutCubic"})
        .animateProperty("spriteContainer", "position.x", { from: -0.2, to: 0, duration: 250, delay: 2750, gridUnits: true, ease: "easeOutSine"})
        //3rd attack
        .animateProperty("spriteContainer", "position.x", { from: 0, to: -0.2, duration: 250, delay: 3000, gridUnits: true, ease: "easeOutCubic"})
        .animateProperty("spriteContainer", "position.x", { from: -0.2, to: 0, duration: 250, delay: 3750, gridUnits: true, ease: "easeOutSine"})
        //4th defend
        .animateProperty("spriteContainer", "position.x", { from: 0, to: 0.75, duration: 250, delay: 4000, gridUnits: true, ease: "easeOutCubic"})
        // Note: I do not understand why it is 0.75 -> 1.90 ... this should be to 3 as far as I'm aware
        .animateProperty("spriteContainer", "position.x", { from: 0.75, to: 1.90, duration: 1000, delay: 4750, gridUnits: true, ease: "easeOutQuint"})
        .persist()
    ...
    .effect()
        ...
        .rotateTowards(r3, {randomOffset: 0})
        .scaleToObject(2.25)
    ...
    .effect()
        ...
        .rotateTowards(b4, {randomOffset: 0})
        .scaleToObject(2)
    ...
    .effect()
        ...
        .animateProperty("spriteContainer", "position.x", { from: 0.75, to: 3, duration: 1000, delay: 650, gridUnits: true, ease: "easeOutQuint"})

    .effect()
        .delay(5500)
        .file(closest("eskie.smoke.01.white"))
        .atLocation(r1, {offset:{x:0.35}, gridUnits:true})
        .size(2, {gridUnits:true})
        .zIndex(1)
        .opacity(0.1)
        .belowTokens()
    ...
    .animation()
        ...
        .on(blue)
        .opacity(1)
        .teleportTo(b4, {relativeToCenter: true})
...
function movement3create(red, blue, config = {}) {
    ...
    seq.animation()
        ...
        .effect()
            ...
            .rotateTowards(b3, {randomOffset: 0})
            .scaleToObject(2.75)
        ...
        .effect()
            .delay(4500)
            .name("effect")
            .atLocation(b3, {offset:{x:-0.5,y:-0.5},gridUnits:true})
            .file(closest("eskie.attack.melee.generic.01.piercing.medium.blue.normal.01"))
            .rotateTowards(r4, {randomOffset: 0})
            .scaleToObject(2.75)
            .spriteOffset({x:-1}, {gridUnits:true})
        ...
        .effect()
            .delay(4700)
            .name("effect")
            .atLocation(b3, {offset:{x:-0.5,y:-0.6},gridUnits:true})
        ...
        .effect()
            .delay(4900)
            .name("effect")
            .atLocation(b3, {offset:{x:-0.5,y:-0.4},gridUnits:true})
            .file(closest("eskie.attack.melee.generic.01.piercing.medium.blue.normal.02"))
            .rotateTowards(r4, { randomOffset: 0})
            .scaleToObject(2.75)
        ...
        .effect()
            ...
            .rotateTowards(b3, {offset:{x:-1,y:-0.5},randomOffset: 0})
            .scaleToObject(2)
            .spriteOffset({x:-1.75}, {gridUnits:true})
            .zIndex(0)
            .playbackRate(2)
        ...
        .effect()
            .delay(4500)
            .file(closest("eskie.particle.05.orange"))
            .atLocation(r4, {randomOffset:0.15, gridUnits:true})
            .size(1, {gridUnits:true})
        ...
        .effect()
            .delay(5250)
            .file(closest("eskie.smoke.01.white"))
            .atLocation(b1, {offset:{x:1}, gridUnits:true})
            .size(2, {gridUnits:true})
            .zIndex(1)
            .mirrorX()
            .opacity(0.1)
        ...
        .effect()
            ...
            .rotateTowards(b1, {randomOffset: 0})
            .scaleToObject(2)
            .spriteOffset({x:-1.75}, {gridUnits:true})
            .zIndex(0)
            .playbackRate(1.5)
        ...
        .effect()
            .delay(6500)
            .file(closest("eskie.smoke.01.white"))
            .atLocation(r1, {offset:{x:-0}, gridUnits:true})
            .size(2, {gridUnits:true})
            .zIndex(1)
            .opacity(0.1)
            .belowTokens()
