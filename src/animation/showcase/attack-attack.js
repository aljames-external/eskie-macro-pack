...
function movement1create(red, blue, config) {    
    ...
    seq.animation()
        ...
        .effect()
            .name("Trail")
            .file(file("eskie.trail.token.generic.02.blue"))
        ...
        .effect()
            .name("Trail")
            .file(file("eskie.trail.token.generic.02.red"))
        ...
        .effect()
            .file(file("eskie.attack.melee.generic.01.slashing.medium.blue.fast.03"))
        ...
        .effect()
            .file(file("eskie.attack.melee.generic.01.slashing.medium.red.fast.03"))
        ...
        .effect()
            .file(file("eskie.particle.05.orange"))
        ...
        .effect()
            .name("gob")
            .delay(150)
            .file(file("eskie.particle.07.orange"))
        ...
        .effect()
            .name("gob")
            .delay(150)
            .file(file("eskie.particle.08.orange"))
            .atLocation(config.positions['b2'], {offset:{x:0.5}, gridUnits:true})
...
function movement2create(red, blue, config) {
    ...
    .effect()
        ...
        .file(file("eskie.attack.melee.generic.01.slashing.medium.blue.normal.01"))
    ...
    .effect()
        ...
        .file(file("eskie.attack.melee.generic.01.slashing.light.red.normal.01"))
    ...
    .effect()
        .delay(2050)
        .file(file("eskie.particle.06.orange"))
        .atLocation(config.positions['b4'])
        .size(2, {gridUnits:true})
        .spriteOffset({x:1},{gridUnits:true})
        .spriteRotation(90)
    ...
    .effect()
        ...
        .name("effect")
        .atLocation(config.positions['r3'])
        .file(file("eskie.attack.melee.generic.01.slashing.medium.red.normal.02"))
        .rotateTowards(config.positions['b4'],{randomOffset: 0})
        .scaleToObject(2.25)
        .spriteOffset({x:-1},{gridUnits:true})
        .zIndex(2)
    ...
    .effect()
        ...
        .name("effect")
        .atLocation(config.positions['b4'])
        .file(file("eskie.attack.melee.generic.01.slashing.light.blue.normal.03"))
        .rotateTowards(config.positions['r3'],{randomOffset: 0})
        .scaleToObject(2)
        .spriteOffset({x:-1.5},{gridUnits:true})
        .zIndex(0)
    ...
    .effect()
        ...
        .name("effect")
        .atLocation(config.positions['r3'])
        .file(file("eskie.attack.melee.generic.01.slashing.light.red.fast.03"))
        .rotateTowards(config.positions['b4'],{randomOffset: 0})
        .scaleToObject(2)
        .spriteOffset({x:-1},{gridUnits:true})
        .zIndex(2)
    ...
    .effect()
        ...
        .name("effect")
        .atLocation(config.positions['b4'])
        .file(file("eskie.attack.melee.generic.01.slashing.light.blue.slow.01"))
        .rotateTowards(config.positions['r3'],{randomOffset: 0})
        .scaleToObject(2)
        .spriteOffset({x:-1.5},{gridUnits:true})
    ...
    .effect()
        ...
        .name("effect")
        .atLocation(config.positions['b4'])
        .file(file("eskie.attack.melee.generic.01.slashing.heavy.blue.slow.03"))
        .rotateTowards(config.positions['r3'],{randomOffset: 0})
        .scaleToObject(2.75)
    ...
    .effect()
        ...
        .name("effect")
        .atLocation(config.positions['r3'])
        .file(file("eskie.attack.melee.generic.01.slashing.light.red.slow.02"))
        .rotateTowards(config.positions['b4'],{randomOffset: 0})
        .scaleToObject(2)
...
function movement3create(red, blue, config) {
    ...
    seq.animation()
        ...
        .effect()
            ...
            .name("effect")
            .atLocation(config.positions['r3'])
            .file(file("eskie.attack.melee.generic.01.bludgeoning.medium.red.normal.03"))
            .rotateTowards(config.positions['b4'],{randomOffset: 0})
            .scaleToObject(2.25)
            .spriteOffset({x:-1},{gridUnits:true})
            .mirrorY()
        ...
        .effect()
            ...
            .name("effect")
            .atLocation(config.positions['b4'])
            .file(file("eskie.attack.melee.generic.01.slashing.light.blue.normal.01"))
            .rotateTowards(config.positions['r3'],{randomOffset: 0})
            .scaleToObject(2)
            .spriteOffset({x:-1.75},{gridUnits:true})
            .rotate(90)
        ...
        .effect()
            ...
            .name("effect")
            .atLocation(config.positions['r3'])
            .file(file("eskie.attack.melee.generic.01.bludgeoning.heavy.red.slow.01"))
            .rotateTowards(config.positions['b4'],{randomOffset: 0})
            .scaleToObject(2.25)
            .spriteOffset({x:-1},{gridUnits:true})
            .zIndex(2)
        ...
        .effect()
            ...
            .name("effect")
            .atLocation(config.positions['b4'])
            .file(file("eskie.attack.melee.generic.01.slashing.light.blue.slow.02"))
            .rotateTowards(config.positions['r3'],{randomOffset: 0})
            .scaleToObject(2)
            .spriteOffset({x:-1.75},{gridUnits:true})
            .zIndex(0)
        ...
        .effect()
            ...
            .name("effect")
            .atLocation(config.positions['r4'])
            .file(file("eskie.attack.melee.generic.01.bludgeoning.heavy.red.slow.02"))
        ...
        .effect()
            ...
            .file(file("eskie.attack.melee.generic.01.piercing.medium.blue.normal.01"))
        ...
        .effect()
            ...
            .file(file("eskie.attack.melee.generic.01.piercing.medium.blue.normal.02"))
            .rotateTowards(config.positions['r4'],{ randomOffset: 0})
            .scaleToObject(2.75)
        ...
        .effect()
            ...
            .name("effect")
            .atLocation(config.positions['r4'])
            .file(file("eskie.attack.melee.generic.01.slashing.light.red.slow.01"))
        ...
        .effect()
            ...
            .name("effect")
            .atLocation(config.positions['b1'],{offset:{x:1}, gridUnits:true})
            .file(file("eskie.attack.melee.generic.01.piercing.heavy.blue.slow.01"))
            .rotateTowards(config.positions['r4'],{randomOffset: 0})
            .scaleToObject(3.25)
            .spriteOffset({x:-1},{gridUnits:true})
        ...
        .effect()
            ...
            .name("effect")
            .atLocation(config.positions['r4'])
            .file(file("eskie.attack.melee.generic.01.bludgeoning.medium.red.fast.01"))
